...
def _rem_shared_instructions(user: str) -> str:
    ...
    "NICKNAMES:\n"
    f"SU develops nicknames and forms of address for {user} over time. "
    "If SU used any nicknames or alternative names during this conversation, "
    "or if new personal context emerged that suggests one (a role, a shared "
    "joke, a title, a preference), update the 'people/user-nicknames' note. "
    "Create it if it doesn't exist yet with initial entries derived from "
    "the user's name. Use observation syntax:\n"
    f"  - [nickname] \"Boss\" — casual deference, everyday #familiar\n"
    "  - [context] User reacted negatively to \"buddy\" — avoid #retired\n"
    "Keep the active repertoire to about 5-8 names. If the user explicitly "
    "asked SU not to use a certain name, record that clearly.\n\n"
